...
public class JoinArrays {
   ...
   public static void main(String[] args) {
      double[] mondayTemperatures = {85.3, 95.8, 72.9}; // perfect size array
      double[] tuesdayTemperatures = {68.3, 81.4, 74.8}; // perfect size array
   ...
   public static double[] joinArrays (double[] firstArray, double[] secondArray) {
      ...
      // Return the perfect size result array
      return resultArray;
   }
}
